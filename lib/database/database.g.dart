...
class $MediaTable extends Media with TableInfo<$MediaTable, MediaData> {
  ...
  late final GeneratedColumnWithTypeConverter<MediaType, int> type =
      GeneratedColumn<int>(
        ...
        type: DriftSqlType.int,
        requiredDuringInsert: true,
      ).withConverter<MediaType>($MediaTable.$convertertype);
...
final class $$DiaryEntriesTableReferences
  ...
  _entryTagsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.entryTags,
    aliasName: 'diary_entries__id__entry_tags__entry_id',
  );
  ...
  static MultiTypedResultKey<$MediaTable, List<MediaData>> _mediaRefsTable(
    ...
    db.media,
    aliasName: 'diary_entries__id__media__entry_id',
  );
...
final class $$EntryTagsTableReferences
  ...
  static $DiaryEntriesTable _entryIdTable(_$AppDatabase db) =>
      db.diaryEntries.createAlias('entry_tags__entry_id__diary_entries__id');
...
final class $$MediaTableReferences
  ...
  static $DiaryEntriesTable _entryIdTable(_$AppDatabase db) =>
      db.diaryEntries.createAlias('media__entry_id__diary_entries__id');
                  ...
                  >(state) {
                    if (entryId) {
                      state = state.withJoin(
                        currentTable: table,
                        currentColumn: table.entryId,
                        referencedTable: $$MediaTableReferences._entryIdTable(
                          db,
                        ),
